...
public 
        ...
        , cosim("cosim") 
    {
        ...
        sensitive << llc_rsp_out_data_coh_msg << llc_rsp_out_data_addr << llc_rsp_out_data_line << llc_rsp_out_data_invack_cnt 
                  << llc_rsp_out_data_req_id << llc_rsp_out_data_dest_id << llc_rsp_out_data_word_offset;
        SC_METHOD(thread_llc_dma_rsp_out_data_conv);i
        sensitive << llc_dma_rsp_out_data_coh_msg << llc_dma_rsp_out_data_addr << llc_dma_rsp_out_data_line << llc_dma_rsp_out_data_invack_cnt 
                  << llc_dma_rsp_out_data_req_id << llc_dma_rsp_out_data_dest_id << llc_dma_rsp_out_data_word_offset;
        SC_METHOD(thread_llc_fwd_out_data_conv);
        sensitive << llc_fwd_out_data_coh_msg << llc_fwd_out_data_addr << llc_fwd_out_data_req_id << llc_fwd_out_data_dest_id; 
        SC_METHOD(thread_llc_mem_req_data_conv);
        sensitive << llc_mem_req_data_hwrite << llc_mem_req_data_hsize << llc_mem_req_data_hprot << llc_mem_req_data_addr << llc_mem_req_data_line; 
        SC_METHOD(thread_llc_rst_tb_done_data_conv);
        sensitive << llc_rst_tb_done_data; 

        cosim.clk(clk);
        cosim.rst(rst);
        cosim.llc_req_in_valid(llc_req_in.valid);
        cosim.llc_req_in_data_coh_msg(llc_req_in_data_conv.coh_msg);
        cosim.llc_req_in_data_hprot(llc_req_in_data_conv.hprot);
        cosim.llc_req_in_data_addr(llc_req_in_data_conv.addr);
        cosim.llc_req_in_data_line(llc_req_in_data_conv.line);
        cosim.llc_req_in_data_req_id(llc_req_in_data_conv.req_id);
        cosim.llc_req_in_data_word_offset(llc_req_in_data_conv.word_offset);
        cosim.llc_req_in_data_valid_words(llc_req_in_data_conv.valid_words);
        cosim.llc_req_in_ready(llc_req_in.ready);
        cosim.llc_dma_req_in_valid(llc_dma_req_in.valid);
        cosim.llc_dma_req_in_data_coh_msg(llc_dma_req_in_data_conv.coh_msg);
        cosim.llc_dma_req_in_data_hprot(llc_dma_req_in_data_conv.hprot);
        cosim.llc_dma_req_in_data_addr(llc_dma_req_in_data_conv.addr);
        cosim.llc_dma_req_in_data_line(llc_dma_req_in_data_conv.line);
        cosim.llc_dma_req_in_data_req_id(llc_dma_req_in_data_conv.req_id);
        cosim.llc_dma_req_in_data_word_offset(llc_dma_req_in_data_conv.word_offset);
        cosim.llc_dma_req_in_data_valid_words(llc_dma_req_in_data_conv.valid_words);
        cosim.llc_dma_req_in_ready(llc_dma_req_in.ready);
        cosim.llc_rsp_in_valid(llc_rsp_in.valid);
        cosim.llc_rsp_in_data_coh_msg(llc_rsp_in_data_conv.coh_msg);
        cosim.llc_rsp_in_data_addr(llc_rsp_in_data_conv.addr);
        cosim.llc_rsp_in_data_line(llc_rsp_in_data_conv.line);
        cosim.llc_rsp_in_data_req_id(llc_rsp_in_data_conv.req_id);
        cosim.llc_rsp_in_ready(llc_rsp_in.ready);
        cosim.llc_mem_rsp_valid(llc_mem_rsp.valid);
        cosim.llc_mem_rsp_data_line(llc_mem_rsp_data_conv.line);
        ...
        cosim.llc_rsp_out_data_coh_msg(llc_rsp_out_data_conv.coh_msg);
        cosim.llc_rsp_out_data_addr(llc_rsp_out_data_conv.addr);
        cosim.llc_rsp_out_data_line(llc_rsp_out_data_conv.line);
        cosim.llc_rsp_out_data_invack_cnt(llc_rsp_out_data_conv.invack_cnt);
        cosim.llc_rsp_out_data_req_id(llc_rsp_out_data_conv.req_id);
        cosim.llc_rsp_out_data_dest_id(llc_rsp_out_data_conv.dest_id);
        cosim.llc_rsp_out_data_word_offset(llc_rsp_out_data_conv.word_offset);
        cosim.llc_rsp_out_ready(llc_rsp_out.ready);
        cosim.llc_dma_rsp_out_valid(llc_dma_rsp_out.valid);
        cosim.llc_dma_rsp_out_data_coh_msg(llc_dma_rsp_out_data_conv.coh_msg);
        cosim.llc_dma_rsp_out_data_addr(llc_dma_rsp_out_data_conv.addr);
        cosim.llc_dma_rsp_out_data_line(llc_dma_rsp_out_data_conv.line);
        cosim.llc_dma_rsp_out_data_invack_cnt(llc_dma_rsp_out_data_conv.invack_cnt);
        cosim.llc_dma_rsp_out_data_req_id(llc_dma_rsp_out_data_conv.req_id);
        cosim.llc_dma_rsp_out_data_dest_id(llc_dma_rsp_out_data_conv.dest_id);
        cosim.llc_dma_rsp_out_data_word_offset(llc_dma_rsp_out_data_conv.word_offset);
        cosim.llc_dma_rsp_out_ready(llc_dma_rsp_out.ready);
        cosim.llc_fwd_out_valid(llc_fwd_out.valid);
        cosim.llc_fwd_out_data_coh_msg(llc_fwd_out_data_conv.coh_msg);
        cosim.llc_fwd_out_data_addr(llc_fwd_out_data_conv.addr);
        cosim.llc_fwd_out_data_req_id(llc_fwd_out_data_conv.req_id);
        cosim.llc_fwd_out_data_dest_id(llc_fwd_out_data_conv.dest_id);
        cosim.llc_fwd_out_ready(llc_fwd_out.ready);
        cosim.llc_mem_req_valid(llc_mem_req.valid);
        cosim.llc_mem_req_data_hwrite(llc_mem_req_data_conv.hwrite);
        cosim.llc_mem_req_data_hsize(llc_mem_req_data_conv.hsize);
        cosim.llc_mem_req_data_hprot(llc_mem_req_data_conv.hprot);
        cosim.llc_mem_req_data_addr(llc_mem_req_data_conv.addr);
        cosim.llc_mem_req_data_line(llc_mem_req_data_conv.line);
    ...
    sc_signal<llc_req_in_t> llc_req_in_data_conv; 
    sc_signal<llc_dma_req_in_t> llc_dma_req_in_data_conv;
    sc_signal<llc_rsp_in_t> llc_rsp_in_data_conv; 
    sc_signal<llc_mem_rsp_t> llc_mem_rsp_data_conv; 
    sc_signal<bool> llc_rst_tb_data_conv; 

    sc_signal<llc_rsp_out_t> llc_rsp_out_data_conv;
    sc_signal<llc_rsp_out_t> llc_dma_rsp_out_data_conv;
    sc_signal<llc_fwd_out_t> llc_fwd_out_data_conv;
    sc_signal<llc_mem_req_t> llc_mem_req_data_conv; 
    sc_siganl<bool> llc_rst_tb_done_data_conv; 
#ifdef STATS_ENABLE
