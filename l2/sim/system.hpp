...
public:
    ...
    put_get_channel<l2_inva_t> l2_inval_chnl;
	...
	tb->clk(clk);
	tb->rst(rst);
	tb->l2_cpu_req(l2_cpu_req_chnl);
	tb->l2_fwd_in(l2_fwd_in_chnl);
	tb->l2_rsp_in(l2_rsp_in_chnl);
	tb->l2_flush(l2_flush_chnl);
	tb->l2_req_out(l2_req_out_chnl);
	tb->l2_rsp_out(l2_rsp_out_chnl);
	tb->l2_rd_rsp(l2_rd_rsp_chnl);
	tb->l2_inval(l2_inval_chnl);
#ifdef STATS_ENABLE
	tb->l2_stats(l2_stats_chnl);
#endif
    }
};
